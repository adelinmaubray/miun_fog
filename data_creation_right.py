...
def fermentation_creation():
    treacle = np.random.normal(t_treacle,t_treacle_tol/5,time)
    seeding = np.random.normal(t_seeding,t_seeding_tol/5,time)
    water = np.random.normal(t_water,t_water_tol/5,time)
    temperature = np.random.normal(T_1,T_1_tol/5,time)
    pression = np.random.normal(p,p_tol/5,time)
    pH_temp = np.random.normal(pH,pH_tol/5,time)
    out = np.random.normal(pourcentage_output_1,pourcentage_output_1_tol/5,time)
...
def separator_creation():
    tour_minute = np.random.normal(tr_min,tr_min_tol/5,time)
    tempature = np.random.normal(T_2,T_2_tol/5,time)
    out = np.random.normal(t_output_2,t_output_2_tol/5,time)
...
def washer_creation():
    hum = np.random.normal(humidity,humidity_tol/5,time)
    out = np.random.normal(t_output_3,t_output_3_tol/5,time)
